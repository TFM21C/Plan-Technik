...
import { CircuitComponent, ComponentType, Pin } from '../../types/circuit'; // Pin importiert

// HIER IST DER FIX: Die vollständige, korrekte Schnittstelle
  ...
  const renderVisual = () => {
    ...
    switch (component.type) {
        case ComponentType.PowerSource24V: case ComponentType.PowerSource0V:
            return <g><line x1="0" y1="0" x2="400" y2="0" style={style} /><text x="-35" y="5" fontSize="14" fill="black">{component.label}</text></g>;
        ...
        case ComponentType.Motor:
            return <g><circle cx="16" cy="16" r="12" style={style} /><text x="12" y="21" fontSize="14px" style={{ fill: strokeColor, stroke: 'none', userSelect: 'none' }}>M</text><text x="32" y="18" style={textStyle}>{component.label}</text></g>;
